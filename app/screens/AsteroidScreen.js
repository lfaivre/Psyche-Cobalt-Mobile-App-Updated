        ...
        >
          ...
          >
            ...
            <Text style={infoPageStyle.pageBodyText}>
              ...
              protoplanet, one of the building blocks of the Sun’s planetary
              system. At Psyche scientists will explore, for the first time
              ever, a world made not of rock or ice, but of metal.
            </Text>
            <Image
            ...
            />
            <Text style={infoPageStyle.pageBodyText}>
              One scenario is that long ago, a protoplanet that had separated
              internally into a rocky mantle and iron core suffered violent
              impacts that stripped away its mantle, leaving only the metal
              core. Or is Psyche a survivor of some more unusual process not yet
              imagined?
            </Text>
            ...
            <Card style={infoPageStyle.cardStyle}>
              ...
              <CardItem style={infoPageStyle.cardBody}>
                <Text style={infoPageStyle.cardCaptionText}>
                  ...
                  hit-and-run collisions, common when the solar system was
                  forming. Thus Psyche may be able to tell us how Earth’s core
                  and the cores of the other terrestrial planets came to be.
                </Text>
              </CardItem>
            ...
            <Text style={infoPageStyle.pageBodyText}>
              If Psyche were a perfect sphere, it would have a diameter of 140
              miles ( 226 km), or about the length of the state of Massachusetts
              (leaving out Cape Cod). It would have a surface area of about
              246,300 square miles or 641,800 square kilometers, making it just
              smaller than the area of the state of Texas and quite a bit larger
            ...
            <Text style={infoPageStyle.pageBodyText}>
              Psyche follows an orbit in the outer part of the main asteroid
              belt, at an average distance from the Sun of 3 astronomical units
              (AU); Earth orbits at 1 AU.
            </Text>

            <Text style={infoPageStyle.pageHeadingTextSmall}>Our Mission</Text>
            <Text style={infoPageStyle.pageBodyText}>
              The science goals of the Psyche Mission are to understand these
              building blocks of planet formation and to explore first-hand a
              wholly new and unexplored type of world. The mission team seeks to
              determine whether Psyche really is a protoplanetary core, how old
              it is, whether it formed in similar ways to the Earth’s core, and
